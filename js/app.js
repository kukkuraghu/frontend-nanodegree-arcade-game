...
var NO_OF_GRASS_ROWS = 2; //Number of grass rows
...
Enemy.prototype.init = function() {
    ...
    //The initial position will be always ahead of the game board. 
    ...
    this.row = getRandomInt(NO_OF_WATER_ROWS, NO_OF_FIELD_ROWS + NO_OF_WATER_ROWS); 
...
Enemy.prototype.collisionWithPlayer = function(player) {
    ...
    //if the enemy is in the same cell with the player, there is collision, return true.
    if ((player.row == this.row) && (player.col == col)) {
        return true;
    }
